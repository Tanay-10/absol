  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-6">
      <PageHeader
        ...
        description="Placeholder route for upcoming portfolio impact tooling inside the Observer shell."
        meta={
          <>
      ...
      <SurfaceCard tone="muted" className="flex flex-1 items-center p-6">
        <p className="max-w-2xl text-sm leading-7 text-[var(--text-secondary)] sm:text-base">
          Detailed exposure analysis arrives in a later task. This page stays intentionally light until that work lands.
        </p>
      </SurfaceCard>
    </div>
  );
